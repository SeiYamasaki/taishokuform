...
class FormController extends Controller
{
    ...
    public function submit(Request $request)
    {
        ...
        $validator = Validator::make($request->all(), [
            ...
            'work_contact_phone' => 'nullable|string|max:20|regex:/^0\d{1,4}-\d{1,4}-\d{4}$/', // ← 唯一の「nullable」
            ...
            'account_number' => 'required|string|max:20|regex:/^\d{7,}$/|unique:bank_accounts,account_number',
